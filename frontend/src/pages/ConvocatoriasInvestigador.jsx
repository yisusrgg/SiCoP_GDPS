...
export default function ConvocatoriasInvestigador({ user = { type: "Investigador" } }) {
  ...
  }, [activeIndex, convocatorias, slideWidth, itemsPerView]);
    ...
    <div className="mx-auto text-center" style={{ minHeight: "100vh", width: "100%" }}>
      ...
      >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', px: { xs: 1, sm: 4 }, py: 3 }}>
          <Box ref={wrapperRef} sx={{ position: 'relative', width: '100%', maxWidth: 'min(1200px, 95vw)', mx: 'auto', overflow: 'visible', pb: 4, pt: 2 }}>
                  ...
                  <div onClick={() => setActiveIndex(idx)}>
                    <ConvocatoriasCard
                      ...
                      convocatoria={{
                        ...
                        fechaFinFinanciamiento: convocatoria.fechaFin,
                        archivo: convocatoria.archivo
                      }}
