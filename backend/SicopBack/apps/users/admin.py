...
class UserChangeForm(forms.ModelForm):
	...
	read-only display of the hashed password."""
...
class UserAdmin(BaseUserAdmin):
	...
	list_display = ('username', 'email', 'name', 'last_name', 'role', 'is_staff', 'is_active')
	list_filter = ('is_staff', 'is_active', 'role')
	fieldsets = (
		(None, {'fields': ('username', 'email', 'password')}),
		('Personal info', {'fields': ('name', 'last_name', 'image', 'role')}),
